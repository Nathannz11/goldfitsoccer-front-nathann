...
export const AuthProvider = ({children}) => {
  ...
  let loginUser = async event => {
    ...
    let response = await fetch(`https://goldfitsoccer-test-02f0da80e648.herokuapp.com/admin/api/token/` , {
      method: 'POST',
      headers: {
  ...
  let updateToken = async ()=> {
    let response = await fetch(`https://goldfitsoccer-test-02f0da80e648.herokuapp.com/admin/api/token/refresh/`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
